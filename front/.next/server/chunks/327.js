...
/* harmony export */ });
const backURL = "https://api.nodebird.shop";
...
function updatePostAPI(data) {
  return axios__WEBPACK_IMPORTED_MODULE_2__["default"].patch(`/post/${data.PostId}`, data);
}

function* updatePost(action) {
  try {
    const result = yield (0,redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__.call)(updatePostAPI, action.data);
    yield (0,redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__.put)({
      type: _reducers_post__WEBPACK_IMPORTED_MODULE_3__/* .UPDATE_POST_SUCCESS */ .js,
      data: result.data
    });
  } catch (err) {
    console.error(err);
    yield (0,redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__.put)({
      type: _reducers_post__WEBPACK_IMPORTED_MODULE_3__/* .UPDATE_POST_FAILURE */ .WC,
      error: err.response.data
    });
  }
}
...
function* watchUpdatePost() {
  yield (0,redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__.takeLatest)(_reducers_post__WEBPACK_IMPORTED_MODULE_3__/* .UPDATE_POST_REQUEST */ .wC, updatePost);
}
